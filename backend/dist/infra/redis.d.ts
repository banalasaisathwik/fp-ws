export declare const serverId: `${string}-${string}-${string}-${string}-${string}`;
export declare const pubClient: import("@redis/client").RedisClientType<{
    json: {
        ARRAPPEND: {
...
export declare const subClient: import("@redis/client").RedisClientType<{
    json: {
        ARRAPPEND: {
            readonly IS_READ_ONLY: false;
            readonly parseCommand: (this: void, parser: import("redis").CommandParser, key: import("redis").RedisArgument, path: import("redis").RedisArgument, json: import("redis").RedisJSON, ...jsons: import("redis").RedisJSON[]) => void;
...
export declare function unsubscribeFromChannel(channel: string): Promise<void>;
